...
The goal of Wedjat is to help individuals who are completely locked in
...
[Step 5](https://developer.chrome.com/apps/first_app#five). You should be able
to ignore the step about enabling flags.
...
letter "e" fires an extended gaze event, while pressing "g" triggers a short
gaze event.
